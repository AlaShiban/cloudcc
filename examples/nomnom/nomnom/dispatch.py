...
from nomnom import inventory

from .events import courier_assigned, order_placed
from .menu import describe

cloudcc.execution_unit(id="dispatch")

assignments = cloudcc.persist(
    boto3.resource("dynamodb").Table("nomnom-assignments"), id="assignments"
)
