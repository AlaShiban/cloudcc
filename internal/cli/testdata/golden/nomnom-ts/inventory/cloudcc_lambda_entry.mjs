// Generated by cloudcc. Lambda entrypoint for execution unit "inventory".
//
...
const _module = await import("./src/nomnom/inventory.ts");
...
export async function handler(event, context) {
  ...
  return { unit: "inventory", handled: false };
}
