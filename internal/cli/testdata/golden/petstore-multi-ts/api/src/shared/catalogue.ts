...
import * as _cloudccOrm from "../../_cloudcc_runtime/orm_knex.js";
import * as _cloudccRedis from "../../_cloudcc_runtime/redis_node.js";
...
// variable.
const db: Knex = _cloudccOrm.connect("petsdb");

const cache: RedisClientType = _cloudccRedis.connect("petCache");
